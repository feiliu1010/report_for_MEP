pro plot_omi_no2_annual_average_region
...
outfile = './OMI_'+Season+'_average_no2_column_'+Yr4+'_china.ps'
...
;filename1 = '/z3/wangsiwen/Satellite/no2/KNMI_L3/v1.0.3/no2_'+Yr4+'_annual_average.bpch'
;filename1 = '/z4/liufei/Satellite/NO2/KNMI_L3_V2.0/no2_KNMI_L3_V2.0_'+Yr4+'_'+Season+'_average_05X05.bpch'
filename1 = '/z4/liufei/Satellite/NO2/KNMI_L3_V2.0/no2_'+Yr4+'_'+Season+'_average.bpch'
ctm_get_data,datainfo1,'IJ-AVG-$',filename = filename1,tracer=1;,tau0=nymd2tau(20050831)
...
; -----------------------------------------------------
   ...
   Colorbar, $
      ...
      ;/vertical,$;/triangle, $
      Min=mindata, Max=maxdata, format='(i2.1)', Unit='',charsize=0.9      

   TopTitle = ' x 10!U15!N molecules cm!U-2!N'
                   
      XYOutS, 0.94, 0.0815, TopTitle,      $
