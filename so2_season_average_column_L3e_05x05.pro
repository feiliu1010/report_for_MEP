pro so2_season_average_column_L3e_05x05,year,season

for year=2007,2011 do begin
;year=2012
season='JantoJun'
;season='JantoSep'
;season='annual'
...
if (nymd eq 20130229) then continue
if (nymd eq 20130230) then continue
if (nymd eq 20130231) then continue
if (nymd eq 20130431) then continue
if (nymd eq 20130631) then continue
if (nymd eq 20130931) then continue
if (nymd eq 20131131) then continue

infile='/home/liufei/Data/Satellite/SO2/NASA_L3e/OMI-Aura_L3-OMSO2e_'+Yr4+mon2+day2+'_v003.bpch'
...
outfile='/home/liufei/Data/Satellite/SO2/NASA_L3e/OMI-Aura_L3-OMSO2e_'+Yr40+'_'+season3+'_v003.05x05.bpch'
